        ...
        public static bool Registration(string[] Register)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("INSERT INTO Registration (Name, Address,Country, State,City, Mobileno, EmailId, Username, Password, ConfirmPassword, Gender, Birthdate, RoleID, CreatedOn) VALUES (@Name, @Address, @Country, @State, @City, @Mobileno, @EmailId, @Username, @Password, @ConfirmPassword, @Gender, @Birthdate, @RoleID, @CreatedOn);", con);
